...
function extractSearchParams(params: SearchParamInput): Record<string, string | undefined> {
  return {
    ...
    pickup: readSearchParam(params, "pickup"),
    pickupHub: readSearchParam(params, "pickupHub"),
    pickupLabel: readSearchParam(params, "pickupLabel"),
    pickup_label: readSearchParam(params, "pickup_label"),
    pickupTime: readSearchParam(params, "pickupTime"),
    doorsTime: readSearchParam(params, "doorsTime"),
    ...
    decision_corridor: readSearchParam(params, "decision_corridor"),
    decision_cta: readSearchParam(params, "decision_cta"),
    decision_action: readSearchParam(params, "decision_action"),
    decision_entry: readSearchParam(params, "decision_entry"),
    decision_policy: readSearchParam(params, "decision_policy"),
    decision_option: readSearchParam(params, "decision_option"),
    decision_product: readSearchParam(params, "decision_product"),
    requested_lane: readSearchParam(params, "requested_lane"),
    resolved_lane: readSearchParam(params, "resolved_lane"),
    product_slug: readSearchParam(params, "product_slug"),
