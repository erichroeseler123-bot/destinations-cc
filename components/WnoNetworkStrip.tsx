...
export default function WnoNetworkStrip() {
  return (
    <div className="bg-slate-50 border border-slate-200/80 rounded-3xl p-5 md:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm max-w-5xl mx-auto my-6">
      <div className="space-y-1 max-w-3xl">
        ...
        <p className="text-slate-600 text-xs leading-relaxed">
          Welcome To New Orleans Tours is listed in the Destination Command Center network for New Orleans visitor tour planning, provider routing, and public site verification.
        </p>
      </div>
      <div className="shrink-0">
        <a
          href="https://www.destinationcommandcenter.com/network/welcome-to-new-orleans-tours"
          target="_blank"
