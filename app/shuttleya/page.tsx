      ...
      <section className="mx-auto grid max-w-6xl gap-5 px-5 py-14 sm:px-8 md:grid-cols-2 md:py-20">
        <div className="rounded-3xl border border-emerald-300/20 bg-emerald-300/[0.06] p-7">
          ...
          <ul className="mt-5 space-y-3 text-slate-200">
            ...
            <li>• Routes travelers to a relevant operating company.</li>
            <li>• Publishes comparison and decision-support information.</li>
            <li>• Connects transportation discovery to DCC.</li>
          </ul>
        </div>
        <div className="rounded-3xl border border-rose-300/20 bg-rose-300/[0.05] p-7">
          ...
          <ul className="mt-5 space-y-3 text-slate-200">
            ...
            <li>• ShuttleYa does not take transportation payment.</li>
            <li>• The former Denver ↔ Mighty Argo scheduled shuttle is {truth.public_claims?.denver_to_mighty_argo_scheduled_shuttle === "retired_not_operating" ? "retired and is not operating" : "status unknown"}.</li>
          </ul>
        </div>
      </section>

      <footer className="border-t border-white/10 px-5 py-8 text-center text-sm leading-6 text-slate-500">
        ShuttleYa is a transportation discovery property affiliated with Destination Command Center. {truth.booking?.finality}
      </footer>
    </main>
  );
}
