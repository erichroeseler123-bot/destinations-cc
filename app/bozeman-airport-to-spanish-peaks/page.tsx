...
export const metadata: Metadata = {
  ...
  description: "BZN to Spanish Peaks private transportation with a direct handoff to GoSno's $299 private Suburban service.",
...
export default function Page() {
  return <BigSkyTransportationPage
    ...
    description="Spanish Peaks is part of the same Big Sky service area, with GoSno's published $299 one-way private Suburban rate from BZN."
