...
export const metadata: Metadata = {
  ...
  description: "BZN to Montage Big Sky private transportation with a direct handoff to GoSno's $399 private Suburban service.",
...
export default function Page() {
  return <BigSkyTransportationPage
    ...
    description="Montage Big Sky is included in GoSno's Big Sky service area at the same published $399 one-way private Suburban rate from BZN."
