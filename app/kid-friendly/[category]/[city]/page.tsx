...
export function generateStaticParams() {
  return listOverlayCitySlugsByType("kid-friendly").flatMap((city) =>
    listOverlayCategoriesByTypeAndCity("kid-friendly", city).map((category) => ({
...
export async function generateMetadata({ params }: { params: Promise<Params> }) {
  ...
  return buildOverlayCategoryMetadata(cityNode, overlay, category, `/kid-friendly/${category}/${city}`);
}
