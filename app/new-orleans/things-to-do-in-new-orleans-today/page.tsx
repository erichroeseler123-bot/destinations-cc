...
import LiveTodayOptions from "../components/LiveTodayOptions";

export const metadata = {
  title: "Things to Do in New Orleans Today | Same-Day Tour Ideas",
  description:
    "Plan what to do in New Orleans today with a live daypart and weather-aware shortlist, current operator booking paths, and a quick chooser for your group and timing.",
...
const faqs = [
  {
    ...
    answer:
      "A city overview, daytime river cruise, or another shorter experience can be a practical first move because it gives you context without committing the whole day. The best fit depends on your available time, weather, group ages, transportation needs, and how late in the day you are starting.",
  },
  {
    question: "Can I book a New Orleans tour at the last minute?",
    answer:
      "Sometimes. Same-day inventory changes throughout the day, so use the current operator booking path on each experience to confirm departure times, prices, pickup details, booking cutoff, and availability before you make plans around it.",
  },
  {
    question: "What should I do in New Orleans today if it rains?",
    answer:
      "The live shortlist favors lower-exposure or covered formats when rain risk is high and removes clearly exposed options from its top recommendations. Operator weather policies and actual operating decisions still control the booked experience.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#080708] text-[#fdfbf7]">
      ...
      <CinematicPageHero
        ...
        intro="Need a plan for the next few hours? Start with the live New Orleans daypart and weather-aware shortlist, then confirm today's actual times, prices, cutoff and availability with the operator before booking."
        image="/images/travel-markets/new-orleans/french-quarter-street.jpg"
        actions={[
          { href: "#options", label: "See What Fits Now", detail: "Current daypart + weather", primary: true },
      ...
      <section className="border-t border-[#d4af37]/20 bg-[#0b090c] px-6 py-14">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-white/70">The chooser narrows the catalog around your group, timing, eligibility and logistics instead of making you sort through everything.</p>
