            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center md:items-start text-center md:text-left gap-4">
              ...
              {product.detailSummary && (
                <div className="mt-2 border-l-4 border-[#d4af37] pl-4">
                  <span className="text-sm font-bold text-[#fdfbf7] tracking-wider">
                    {product.detailSummary}
                  </span>
                </div>
              )}
          ...
          <div className="relative w-full h-[70vh] min-h-[500px] max-h-[700px] overflow-hidden bg-[#1a1a1a]">
            ...
            <div className="absolute inset-0 flex items-end">
              <div className="max-w-4xl mx-auto w-full px-6 pb-12 md:pb-16 text-center md:text-left">
                ...
                <p className="text-sm md:text-base font-bold text-[#d4af37] uppercase tracking-widest mb-6">
                  Operated by {product.operatorName}
                </p>
                {product.detailSummary && (
                  <div className="mb-8 border-l-4 border-[#d4af37] pl-4 max-w-2xl mx-auto md:mx-0">
                    <span className="text-base md:text-lg font-bold text-[#fdfbf7] tracking-wider">
                      {product.detailSummary}
                    </span>
                  </div>
                )}
          ...
          <div className="grid md:grid-cols-12 gap-12 md:gap-16">
            ...
            <div className="md:col-span-7 space-y-12">
              ...
              <section>
                ...
                <p className="text-[#cccccc] leading-relaxed text-lg font-light">
                  {product.detailSummary || product.description}
                </p>
            ...
            <div className="md:col-span-5 space-y-8">
              ...
              <div className="sticky top-24 space-y-8">
                ...
                {/* 7. What to verify before booking */}
                <section className="bg-[#1a1a1a] p-8 border border-[#2a2a2a]">
                  <h2 className="text-xl font-[var(--font-accent)] font-bold text-[#fdfbf7] mb-4 border-b border-[#2a2a2a] pb-4">
                    Verify Before Booking
                  </h2>
                  <p className="text-sm text-[#aaaaaa] mb-4 leading-relaxed">
                    Check the following details on the operator’s FareHarbor checkout:
                  </p>
                  {product.bookingConfirmations && product.bookingConfirmations.length > 0 ? (
                    <ul className="space-y-3">
                      {product.bookingConfirmations.map((conf, idx) => (
                        <li key={idx} className="flex gap-3 text-sm text-[#cccccc] leading-relaxed">
                    ...
                    <ul className="space-y-3">
                      <li className="flex gap-3 text-sm text-[#cccccc] leading-relaxed">
                        <span className="text-[#d4af37]">✓</span>
                        <span>Exact start time</span>
                      </li>
                      <li className="flex gap-3 text-sm text-[#cccccc] leading-relaxed">
                        <span className="text-[#d4af37]">✓</span>
                        <span>Meeting or transportation location</span>
                      </li>
                      <li className="flex gap-3 text-sm text-[#cccccc] leading-relaxed">
                        <span className="text-[#d4af37]">✓</span>
          ...
          <div className="bg-[#101010] py-20 px-6 border-t border-[#2a2a2a]">
            <div className="max-w-4xl mx-auto">
              <div className="mb-10 text-center">
                ...
                <h2 className="text-2xl md:text-3xl font-[var(--font-accent)] font-bold text-[#fdfbf7] uppercase tracking-widest">
                  Also Consider
                </h2>
              </div>
