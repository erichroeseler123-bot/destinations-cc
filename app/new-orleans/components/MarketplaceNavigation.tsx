      ...
      <header className={visualStyles.marketHeader}>
        <div className={visualStyles.marketHeaderInner}>
          ...
          <nav className={visualStyles.marketDesktopNav}>
            <Link href="/tours">Tours</Link><Link href="/high-intent-tours">Plan by Need</Link><Link href="/things-to-do-in-new-orleans-today">Today</Link><Link href="/new-orleans-tours-tonight">Tonight</Link><Link href="/help-me-choose">Help Me Choose</Link><Link href="/guides/french-quarter-orientation">$5 Orientation</Link><Link href="/compare">Compare</Link><Link href="/french-quarter-welcome-stop">Concierge</Link>
          </nav>
  ...
  return (
    <footer className="bg-[#110e14] text-[#fdfbf7] border-t-4 border-[#d4af37]">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        <div><h4 className="font-serif text-2xl mb-6 text-[#d4af37]">Explore</h4><nav className="flex flex-col gap-4 font-sans font-light text-[#fdfbf7]/80"><Link href="/tours">All Tours</Link><Link href="/high-intent-tours">Plan Tours By Need</Link><Link href="/things-to-do-in-new-orleans-today">Things To Do Today</Link><Link href="/new-orleans-tours-tonight">Tours Tonight</Link><Link href="/swamp-tours">Swamp Tours</Link><Link href="/plantation-tours">Plantations</Link><Link href="/compare">Compare Tours</Link></nav></div>
        <div><h4 className="font-serif text-2xl mb-6 text-[#d4af37]">Concierge Desk</h4><nav className="flex flex-col gap-4 font-sans font-light text-[#fdfbf7]/80"><Link href="/guides/french-quarter-orientation">$5 French Quarter Orientation</Link><Link href="/french-quarter-welcome-stop">Planning Help</Link><Link href="/guides/visitor-rewards">Visitor Rewards</Link><Link href="/first-time-new-orleans-tours">First-Time Visitors</Link><Link href="/new-orleans-tours-for-families">Families</Link></nav></div>
        <div><h4 className="font-serif text-2xl mb-6 text-[#d4af37]">Planning Guides</h4><nav className="flex flex-col gap-4 font-sans font-light text-[#fdfbf7]/80"><Link href="/best-swamp-tour-with-transportation">Swamp Tours With Transportation</Link><Link href="/4-hours-in-new-orleans">Only Have Four Hours?</Link><Link href="/things-to-do-before-a-cruise-new-orleans">Before a Cruise</Link><Link href="/things-to-do-after-a-cruise-new-orleans">After a Cruise</Link><Link href="/guides/how-far-are-swamp-tours-from-new-orleans">Distance to Swamps</Link></nav></div>
