      ...
      <header className={visualStyles.marketHeader}>
        <div className={visualStyles.marketHeaderInner}>
          ...
          <nav className={visualStyles.marketDesktopNav}>
            <Link href="/tours">Tours</Link><Link href="/things-to-do-in-new-orleans-today">Today</Link><Link href="/new-orleans-tours-tonight">Tonight</Link><Link href="/help-me-choose">Help Me Choose</Link><Link href="/guides/french-quarter-orientation">$5 Orientation</Link><Link href="/compare">Compare</Link><Link href="/french-quarter-welcome-stop">Concierge</Link>
          </nav>
  ...
  return (
    <footer className="bg-[#110e14] text-[#fdfbf7] border-t-4 border-[#d4af37]">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        <div><h4 className="font-serif text-2xl mb-6 text-[#d4af37]">Explore</h4><nav className="flex flex-col gap-4 font-sans font-light text-[#fdfbf7]/80"><Link href="/tours">All Tours</Link><Link href="/things-to-do-in-new-orleans-today">Things To Do Today</Link><Link href="/new-orleans-tours-tonight">Tours Tonight</Link><Link href="/swamp-tours">Swamp Tours</Link><Link href="/plantation-tours">Plantations</Link><Link href="/compare">Compare Tours</Link></nav></div>
