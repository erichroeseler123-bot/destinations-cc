  ...
  return (
    <footer className="bg-[#151116] text-[#f6f1e8] border-t border-[#c7a96b]/35">
      <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.1fr_1fr_1fr_1.2fr] gap-14 lg:gap-10">
        ...
        <div><h4 className="font-serif text-xl mb-6 text-[#e1c98f] font-medium">Explore</h4><nav className="flex flex-col gap-3.5 font-sans font-light text-sm text-[#f6f1e8]/70"><Link href="/tours">All Tours</Link><Link href="/riverboat-cruises">Riverboat Cruises</Link><Link href="/ghost-tours">Ghost Tours</Link><Link href="/food-tours">Food & Cocktail Tours</Link><Link href="/guides/things-to-do-in-new-orleans-today">Things To Do Today</Link><Link href="/guides/new-orleans-tours-tonight">Tours Tonight</Link><Link href="/swamp-tours">Swamp Tours</Link><Link href="/plantation-tours">Plantations</Link><Link href="/compare">Compare Tours</Link></nav></div>
