    ...
    <div className="min-h-screen bg-[#151515] text-[#fdfbf7]">
      ...
      <section className="border-t border-white/10 bg-[#110e14] px-6 py-14">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-7 max-w-3xl text-xs leading-5 text-white/55">Participating operators control departure times, pricing, pickup details, age rules, availability and cancellation terms. Confirm the current details during booking.</p>
        </div>
      </section>
    </div>
  );
