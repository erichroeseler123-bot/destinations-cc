...
export default function StickyMobileBookingBar({
  ...
  const isHeld = productSlug === HELD_COMBO_SLUG;
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md">
        ...
        <div className={isHeld ? "grid grid-cols-1 gap-2" : "grid grid-cols-[0.8fr_1.2fr] gap-2"}>
          <PhoneCta
          ...
          >
            {isHeld ? "Call 504-484-9687 to confirm" : "Call us"}
          </PhoneCta>

          {!isHeld && (hasMultipleVariants ? (
            <button
              type="button"
