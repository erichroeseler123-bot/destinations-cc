    ...
    <section className="bg-[#111] border-y border-[#333] py-20 px-6">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
        <div className="border border-[#333] bg-[#171717] p-8">
          ...
          <ul className="text-white/70 text-sm space-y-2 mb-6"><li>8:00 AM or 9:30 AM daily</li><li>Moonwalk by Café Du Monde</li><li>Look for the yellow umbrella</li></ul>
          <Link href="/guides/french-quarter-orientation" className="inline-block bg-[#d4af37] text-black font-bold px-6 py-3 text-xs uppercase tracking-widest hover:bg-white">Reserve a $5 Spot</Link>
        </div>
        <div className="border border-[#333] bg-[#171717] p-8">
