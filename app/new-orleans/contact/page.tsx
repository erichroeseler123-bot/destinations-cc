...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Contact & Group Planning | New Orleans Concierge Desk",
    description:
      "Call or text New Orleans Concierge Desk for tour selection, group planning, and local visitor help.",
  },
};
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-8">
              <div className="flex-1">
                ...
                <p className="text-[var(--nola-ivory)]/70 font-light mb-4">
                  Call or text the Desk for practical planning help, tour selection, or information about the $5 French Quarter Morning Orientation.
                </p>
                <p className="text-[var(--nola-ivory)]/70 font-light mb-6">
