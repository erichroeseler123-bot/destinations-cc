  ...
  return (
    <article className="min-h-screen bg-[#151515] text-[#fdfbf7]">
      ...
      <div className="mx-auto max-w-5xl space-y-12 px-6 py-12 md:py-16">
        ...
        <nav className="border-t border-[#333] pt-8 text-sm flex flex-wrap gap-5"><Link className="text-[#d4af37] underline" href="/areas/french-quarter">French Quarter area guide</Link><Link className="text-[#d4af37] underline" href="/food-tours">Food & cocktail tours</Link><Link className="text-[#d4af37] underline" href="/ghost-tours">Ghost tours</Link><Link className="text-[#d4af37] underline" href="/guides/new-orleans-swamp-tour-without-a-car">Swamp tours without a car</Link><Link className="text-[#d4af37] underline" href="/guides/things-to-do-in-new-orleans-today">Things to do today</Link><Link className="text-[#d4af37] underline" href="/guides/tonight">What to do tonight</Link><Link className="text-[#d4af37] underline" href="/help-me-choose">Help Me Choose</Link></nav>
      </div>
    </article>
  );
}
