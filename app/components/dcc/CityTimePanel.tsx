  ...
  return (
    <aside className="rounded-[26px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,13,26,0.96),rgba(6,9,18,0.96))] p-5 shadow-[0_18px_60px_rgba(0,0,0,0.35)]">
      <div className="flex items-center gap-2">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.22em] text-[#8fd0ff]">Live local clock · {cityName}</p>
      </div>
      ...
      <p className="mt-3 text-xs leading-5 text-white/42">Rendered from the current clock in the destination, not stored as destination content.</p>
    </aside>
  );
}
