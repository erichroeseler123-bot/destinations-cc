...
* Shuttleya: This brand is a transportation discovery and operator-routing satellite. It does not operate vehicles, publish a house shuttle schedule, or accept transportation payment. The former Denver to Mighty Argo scheduled shuttle is retired.
...
| **shuttleya.com / www.shuttleya.com** | `shuttleya.com` | Satellite Market | Transportation discovery and operator routing | `v0-shuttleya` | `prj_SiiHW7Y8DpAzLWCELG8kqfASZM8a` | `dpl_fAfg3Rt3uQFD6fXZXxmqJc3ByMNQ` | `destinations-cc` | `None` | `repurpose-in-progress` | `vercel-project-metadata` | host-routed | host-routed | Operator handoff only; no direct checkout | Former Argo scheduled service retired; direct payment must remain disabled | 2026-08-24 |
