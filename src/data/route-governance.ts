...
const ROOT_ROUTE_GOVERNANCE = [
  ...
  // Cruise Promenade Matrix Pages
  {
    path: "/cozumel",
    publishState: "promoted",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
    notes: "Cruise Promenade Cozumel port hub page.",
  },
  {
    path: "/cozumel-cruise-shore-excursions",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
    notes: "Cruise Promenade Cozumel excursions directory.",
  },
  {
    path: "/roatan",
    publishState: "promoted",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
    notes: "Cruise Promenade Roatan port hub page.",
  },
  {
    path: "/roatan-cruise-shore-excursions",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
    notes: "Cruise Promenade Roatan excursions directory.",
  },
  // Cozumel Intents
  {
    path: "/cozumel-snorkeling-tours",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-beach-club-day-passes",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-catamaran-sailing",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-jeep-tours",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-mayan-ruins",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-atv-adventure-tours",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-private-boat-charters",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-scuba-diving",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/cozumel-food-cooking-tours",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  // Roatan Intents
  {
    path: "/roatan-snorkeling-tours",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-sloth-monkey-hangout",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-west-bay-beach-day-passes",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-zip-line-adventures",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-little-french-key",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-scuba-diving",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-private-island-getaways",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-atv-mud-tours",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/roatan-glass-bottom-boat",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  // Cozumel Terminal Routes
  {
    path: "/puerta-maya-to-chankanaab-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/puerta-maya-to-mr-sanchos",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/puerta-maya-to-paradise-beach",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/puerta-maya-to-punta-sur-eco-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/puerta-maya-to-san-gervasio-ruins",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/international-pier-to-chankanaab-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/international-pier-to-mr-sanchos",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/international-pier-to-paradise-beach",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/international-pier-to-punta-sur-eco-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/international-pier-to-san-gervasio-ruins",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/punta-langosta-to-chankanaab-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/punta-langosta-to-mr-sanchos",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/punta-langosta-to-paradise-beach",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/punta-langosta-to-punta-sur-eco-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/punta-langosta-to-san-gervasio-ruins",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  // Roatan Terminal Routes
  {
    path: "/mahogany-bay-to-west-bay-beach",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/mahogany-bay-to-gumbalimba-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/mahogany-bay-to-little-french-key",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/mahogany-bay-to-daniel-johnsons-monkey-and-sloth-hangout",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/mahogany-bay-to-tabyana-beach",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/coxen-hole-to-west-bay-beach",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/coxen-hole-to-gumbalimba-park",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/coxen-hole-to-little-french-key",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/coxen-hole-to-daniel-johnsons-monkey-and-sloth-hangout",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
  {
    path: "/coxen-hole-to-tabyana-beach",
    publishState: "indexable",
    networkRole: "satellite",
    handoffPolicy: "bidirectional",
  },
