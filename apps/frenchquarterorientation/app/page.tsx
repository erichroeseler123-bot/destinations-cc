...
const decisions = [
  ...
  ["06", "Know when orientation ends", "The orientation is 30 minutes. Once you understand the layout, move on. Tours, food, music, river cruises, and transportation belong with the provider that actually operates them."]
] as const;
  ...
  return <>
    <main>
      ...
      <section className="section" id="first-hour"><div className="shell">
        ...
        <p className="lede">The orientation itself is 30 minutes. No fake countdowns, no invented departure board, and no promise that a particular tour or attraction is available right now. Use this to get oriented; use actual providers for live schedules, prices, tickets, and terms.</p>
      ...
      <section className="section band"><div className="shell split">
        <div><div className="eyebrow" style={{color:"#8c352f"}}>Fast mental map</div><h2>Four edges. A few landmarks. Much less confusion.</h2><ul className="list"><li><strong>Mississippi River:</strong> the downriver-side anchor for Jackson Square and the Moonwalk area.</li><li><strong>Canal Street:</strong> the upriver edge and major transit seam.</li><li><strong>Rampart Street:</strong> the inland edge of the Quarter.</li><li><strong>Esplanade Avenue:</strong> the downriver edge toward Marigny.</li><li><strong>Jackson Square:</strong> the easiest central landmark for many first-time visitors.</li><li><strong>Useful walking scale:</strong> Jackson Square to Canal Street is roughly 10–15 minutes; Jackson Square to Frenchmen Street is roughly 15–20 minutes for most visitors.</li></ul></div>
