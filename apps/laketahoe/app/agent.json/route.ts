const baseUrl = "https://laketahoe.vercel.app";
...
const agentPayload = {
  ...
  disambiguating_description:
    "Lake Tahoe is a governed action surface for Tahoe activity decisions. It should not be treated as mature owned booking execution.",
  dcc_affiliation: {
    ...
    dcc_relationship:
      "Receives Tahoe activity intent from Destination Command Center when a narrowed activity action is appropriate.",
    operational_function:
      "Keeps Tahoe activity choice narrow and preserves fallback boundaries.",
    decision_layer_role: "action surface",
    execution_tier: "fallback_or_partner_action",
    continuity_contract:
      "DCC resolves the Tahoe activity decision; this site must not reopen broad marketplace browsing unless fallback inventory is explicit.",
