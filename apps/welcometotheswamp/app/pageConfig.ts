  ...
  featuredCards: [
    {
      ...
      destination: "wts",
      image: undefined,
      tags: ["open-air ride", "high energy", "fast pace"],
      cta: { label: "Check Availability", href: `https://fareharbor.com/embeds/book/ragincajuntours/?asn=${asn}&flow=940162&ref=wts-airboat`, external: true },
      ...
      decisionReason: "Best for speed, wind, and open-marsh thrills.",
    },
    {
      ...
      cta: { label: "Check Availability", href: `https://fareharbor.com/embeds/book/ragincajuntours/items/590176/?asn=${asn}&flow=392449&ref=wts-covered-boat`, external: true },
      providerType: "affiliate_fallback",
      disclosure: "Confirm boat type, departure point, pickup, and weather terms with the provider.",
      decisionReason: "Best for shade, comfort, and easy conversation.",
    },
    {
      ...
      destination: "wts",
      image: undefined,
      tags: ["private group", "custom pace", "shaded boat"],
      cta: { label: "Check Availability", href: `https://fareharbor.com/embeds/book/ragincajuntours/items/603090/?asn=${asn}&flow=392449&ref=wts-private-boat`, external: true },
      providerType: "affiliate_fallback",
      disclosure: "Tailored private tour. Reservation, pricing, and timing continue on FareHarbor.",
      decisionReason: "Best for families, friend groups, and custom charters.",
    },
    {
      ...
      destination: "wts",
      image: undefined,
      tags: ["hotel pickup", "french quarter", "guided bayou"],
      cta: { label: "Check Availability", href: `https://fareharbor.com/embeds/book/southernstyletours/items/83002/calendar/?asn=${asn}&flow=4344&ref=wts-southernstyle-swamp`, external: true },
      providerType: "affiliate_fallback",
      disclosure: "Pickup varies by hotel zone. Confirm pickup details on FareHarbor before booking.",
      decisionReason: "Best for French Quarter pickup convenience.",
    },
    {
      ...
      destination: "wts",
      image: undefined,
      tags: ["french quarter", "garden district", "city overview"],
      cta: { label: "Check Availability", href: `https://fareharbor.com/embeds/book/southernstyletours/items/51942/calendar/?asn=${asn}&flow=4344&ref=wts-city-tour`, external: true },
      providerType: "affiliate_fallback",
      disclosure: "Sightseeing tour of New Orleans history and neighborhoods. Confirm departure times on FareHarbor.",
      decisionReason: "Best for a complete New Orleans overview.",
    },
  ],
  categoryGrid: {
